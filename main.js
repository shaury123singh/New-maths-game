...
let timeremaining;
let action;
document.getElementById("startrese").onclick=function()
{
    if(playing==true){
        location.reload();
    }
         ...
         playing=true;
         score=0;
         document.getElementsByid("scorevalue").innerHTML=score;
         timeremaining=60;
         document.getElementById("trvalue").innerHTML=timeremaining;
         show("timeremaining");
         //to reset the game
         document.getElementById("startreset").innerHTML="Reset the game";
         showCountDown();
         genrateQA();
...
function hide(id){
    document.getElementsById("timeremaining").style.display="none";
}
function showCountDown(){
    action=setInterval(function(){
        timeremaining--;
        document.getElementById("traval").innerHtml=timeremaining;
        if(timeremaining==0){
            stopCountDown();
            show("gameover");
            document.getElementById("gameover").innerHTML=`
